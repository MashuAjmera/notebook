...
requirejs(
  ...
  function(
    ...
    try {
      ...
      console.log(
        "Error loading custom.js from tree service. Continuing and logging"
      );
      console.warn(err);
    }
    ...
    var session_list = new sesssionlist.SesssionList(
      $.extend(
        {
          events: events
        },
    ...
    var notebook_list = new notebooklist.NotebookList(
      "#notebook_list",
      $.extend(
        {
          contents: contents,
    ...
    var kernel_list = new kernellist.KernelList(
      "#running_list",
      $.extend(
        {
          session_list: session_list
    ...
    if (utils.get_body_data("terminalsAvailable") === "True") {
      terminal_list = new terminallist.TerminalList(
        "#terminal_list",
        common_options
      );
    }
    ...
    var new_buttons = new newnotebook.NewNotebookWidget(
      "#new-buttons",
      $.extend({ contents: contents, events: events }, common_options)
    );
